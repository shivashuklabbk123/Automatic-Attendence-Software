...
class Attendance:
    def __init__(self,root):
        ...
        img =Image.open(r"C:\Users\HP\Documents\Face Recognition System\college_images\smart-attendance.jpg")
        ...
        img1 =Image.open(r"C:\Users\HP\Documents\Face Recognition System\college_images\university.jpg")
        ...
        title_lbl=Label(bg_img,text="ATTEDANCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="white",fg="darkgreen")
        ...
        left_inside_frame.place(x=1,y=135,width=725,height=400)
        ...
        atten_roll=Entry(left_inside_frame,width=22,textvariable=self.var_atten_roll,font=("comicsansns",11,"bold"))
        ...
        atten_name=Entry(left_inside_frame,width=22,textvariable=self.var_atten_name,font=("comicsansns",11,"bold"))
        ...
        atten_dep=Entry(left_inside_frame,width=22,textvariable=self.var_atten_dep,font=("comicsansns",11,"bold"))
        ...
        atten_time=Entry(left_inside_frame,width=22,textvariable=self.var_atten_time,font=("comicsansns",11,"bold"))
        ...
        atten_date=Entry(left_inside_frame,width=22,textvariable=self.var_atten_date,font=("comicsansns",11,"bold"))
        ...
        table_frame.place(x=5,y=5,width=670,height=550)
        ...
        self.AttendanceReportTable.column("roll",width=180)
        self.AttendanceReportTable.column("name",width=170)
        self.AttendanceReportTable.column("department",width=180)
